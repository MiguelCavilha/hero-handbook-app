export const pt = {
  ...
  searchClassSpells: 'Buscar magias de classe...',
  classSpells: 'Magias de Classe',
  spellcastingClass: 'Classe de Conjuração',
  failedToLoadClassSpells: 'Falha ao carregar magias de classe.',
  loading: 'Carregando...',
